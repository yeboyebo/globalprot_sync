...
# @class_declaration globalprot_sync_movistock #
class globalprot_sync_movistock(interna_movistock, helpers.MixinConAcciones):
    pass
...
class movistock(globalprot_sync_movistock, helpers.MixinConAcciones):
    pass
